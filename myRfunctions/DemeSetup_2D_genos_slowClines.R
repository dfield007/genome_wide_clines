...
DemeSetup2D <- function(HZdata,lociNames,demeSize,minSample,removePhenoMiss,transectGradient,transectIntercept,
  ...
  # poolSeqClines <- allChr_Clines_Chr4clines; poolSeqStats <- poolLoc; FigName="Chr4"; plotKASPrep=T
